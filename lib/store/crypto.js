// Criptografia em repouso do documento "settings" (contém segredo: URLs de
// API das unidades), gravado no banco SQLite local — proteção extra caso o
// arquivo data/app.db vaze ou seja lido fora da aplicação. O documento
// "content" não tem segredo e não passa por aqui.
