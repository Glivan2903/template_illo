...
export const DEFAULT_CONTENT = {
  ...
  // Chaves de identidade (ver identidadeProfissional em lib/profissionais.js)
  // dos profissionais cujo link direto de agendamento (em /medicos) foi
  // desativado manualmente pelo admin — todos os outros ficam ativos por
  // padrão quando o módulo está ligado no /superadmin (opt-out, não opt-in).
  profissionaisLinksDesativados: [],
  // identidade -> cenCodigo escolhido, pra profissional que atende em mais
  // de uma especialidade/centro (o link só pode apontar pra uma) — sem
  // entrada aqui, usa a primeira especialidade dele.
  profissionaisLinkCentro: {},
  unidades: {
    matriz: {
...
export const DEFAULT_SETTINGS = {
  featureFlags: {
    ...
    cta: true,
    profissionais: true,
    agendamentoPorProfissional: true,
    orcamento: true,
    agendamento: true,
    areaCliente: true,
