...
export async function getFeatureFlags() {
  ...
  return {
    ...
    // Dentro de /medicos: cada card leva direto pro agendamento já
    // filtrado por aquele profissional (pula pro passo 3 do wizard, ver
    // BookingWizard initialCentro/initialProfissional) em vez do fluxo
    // genérico de /agendamento (mesma página, com ou sem essa flag — se
    // FEATURE_AGENDAMENTO estiver desligado, /agendamento já 404 do
    // mesmo jeito com ou sem os parâmetros extras na URL).
    FEATURE_AGENDAMENTO_POR_PROFISSIONAL: f.agendamentoPorProfissional !== false,
    ...
    // configurada pra essa empresa no /superadmin (settings.openai.apiKey).
