...
export default function EmpresaDetail({ empresa, actions }) {
  ...
  return (
    <div>
      ...
      <div className={fieldStyles.card} style={{ marginTop: '0.75rem', marginBottom: '0.75rem' }}>
        <div className={fieldStyles.cardHead}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div>
              ...
              <h1 className={fieldStyles.cardTitle} style={{ fontSize: '1.25rem', marginTop: '0.15rem' }}>
                {empresa.nome}
              </h1>
              {empresa.link && (
        ...
        <div className={styles.credRow} style={{ marginTop: '0.9rem' }}>
        ...
        {novaSenha && (
          <p className={fieldStyles.statusBox} style={{ marginTop: '0.75rem' }}>
